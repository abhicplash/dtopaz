  ...
  return (
    <ShopLayout>
      <div>
        ...
        <div className="flex flex-wrap gap-9 md:px-32 justify-center pb-10   ">
          {products.map((jwel, index) => {
            return (
              ...
              >
                <img src={jwel.image_url} alt="" className="h-72 w-full  " />
                <div className="flex justify-between items-center w-full p-3 ">
                  <div className="text-left flex flex-col gap-1 text-[#2e728f]">
                  <h1 className=" text-lg capitalize font-bold font-Numbers">{jwel.product_code}</h1>
                    <h1 className="font-Numbers font-bold text-xs">{jwel.article}</h1>
        ...
        <div className="w-full 0 px-10 md:px-32 flex flex-wrap gap-3  my-10
         justify-center">
